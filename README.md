...
史诚鑫：设计矩阵幂法实验、实现矩阵幂法代码、搭建环境并进行ray集群性能测试。

黄煦华：写Readme文档、生成矩阵数据集、搭建环境并实现矩阵幂法代码。

李昕原：收集Applybatch数据集、实现Applybatch代码并完成环境搭建。

汤越：确定项目方向、实现Applybatch代码并完成集群配置和性能测试、制作答辩PPT。